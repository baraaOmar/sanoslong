...
return $conn;
 ...
 $date_start= $_POST['startDateDiet'];
 $date_end= $_POST['endDateDiet'];
...
$exist=true;
    ...
    while($i<5){
$sql = "SELECT name,type FROM food_diet,subscrip WHERE type='$i' and date=ADDDATE('$date_start', INTERVAL '$j' DAY)  and food_diet.food_id =subscrip.food_id";
...
if($exist==true){ $json=json_encode($arr);echo($json);  }else echo("there is no subscribtion in this period");
